...
int main(int argc, char **argv)
{
  ...
  velocity_publisher = masterNode.advertise<geometry_msgs::Twist>("/deepracer1/cmd_vel", 1000);
  ros::Subscriber laser = masterNode.subscribe("/deepracer1/scan", 1, laserCallBack);
