...
// (in-package pointcloud_list.msg)
...
class ListPointCloud {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ListPointCloud(null);
  ...
  static datatype() {
    ...
    return 'pointcloud_list/ListPointCloud';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ListPointCloud(null);
