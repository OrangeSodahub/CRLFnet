...
struct SensorMsgsRadar_
{
  ...
  _fsm4_tracker_counter_type fsm4_tracker_counter;
   ...
   typedef std::vector< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >::other >  _fsm4_tracklist_type;
  _fsm4_tracklist_type fsm4_tracklist;

   typedef std::vector< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >::other >  _rear_sbmp_tracklist_type;
