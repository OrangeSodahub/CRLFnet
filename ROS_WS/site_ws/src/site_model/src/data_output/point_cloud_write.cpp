...
void cloudCB1(const sensor_msgs::PointCloud2 &input)
{
    ...
    if(pcl::io::savePCDFileASCII ("/home/zonlin/IPP_WorkSpace/ROS_WS/site_ws/src/site_model/point_cloud_data/point_cloud1.pcd", cloud)>=0)
...
void cloudCB2(const sensor_msgs::PointCloud2 &input)
{
    ...
    pcl::fromROSMsg(input, cloud);
    if(pcl::io::savePCDFileASCII ("/home/zonlin/IPP_WorkSpace/ROS_WS/site_ws/src/site_model/point_cloud_data/point_cloud2.pcd", cloud)>=0)
...
void cloudCB3(const sensor_msgs::PointCloud2 &input)
{
    pcl::PointCloud<pcl::PointXYZI> cloud;
    pcl::fromROSMsg(input, cloud);
    if(pcl::io::savePCDFileASCII ("/home/zonlin/IPP_WorkSpace/ROS_WS/site_ws/src/site_model/point_cloud_data/point_cloud3.pcd", cloud)>=0)
