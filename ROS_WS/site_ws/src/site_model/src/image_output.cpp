...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    ...
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image11.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image12.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image13.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image14.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image2.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image3.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image41.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image42.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image43.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  ...
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    if(cv::imwrite("/home/zonlin/ROS/site_ws/src/site_model/camera_data/image44.jpg",cv_bridge::toCvShare(msg)->image)>=0)
    {std::cerr << "Saved image11.jpg" << std::endl;}
   // cv::WaitKey(3);
  }
  catch (cv_bridge::Exception& e)
