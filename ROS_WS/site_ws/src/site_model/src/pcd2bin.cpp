...
int main (int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    string in_file = "/home/zonlin/ROS/site_ws/src/site_model/point_cloud_data/bin2pcd/integrated.pcd";
    string out_file = "/home/zonlin/ROS/site_ws/src/site_model/point_cloud_data/pcd2bin/integrated.bin";
