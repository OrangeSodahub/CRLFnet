...
add_custom_target(_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "msgs" "/home/zonlin/IPP_WorkSpace/ROS_WS/site_ws/src/msgs/msg/MsgRadar.msg" "msgs/MsgRadarObject:std_msgs/Header"
)
...
_generate_msg_cpp(msgs
  ...
  "${MSG_I_FLAGS}"
  "/home/zonlin/IPP_WorkSpace/ROS_WS/site_ws/src/msgs/msg/MsgRadarObject.msg;/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/msgs
)
_generate_msg_cpp(msgs
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/msgs)
  install(CODE "execute_process(COMMAND \"/usr/local/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/msgs\")")
  # install generated code
  install(
