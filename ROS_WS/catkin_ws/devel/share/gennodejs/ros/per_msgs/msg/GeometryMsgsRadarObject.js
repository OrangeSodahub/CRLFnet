...
class GeometryMsgsRadarObject {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GeometryMsgsRadarObject(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GeometryMsgsRadarObject(null);
...
module.exports = GeometryMsgsRadarObject;
