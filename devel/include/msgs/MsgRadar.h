...
struct MsgRadar_
{
  ...
  _total_vehicles_right_type total_vehicles_right;
   ...
   typedef std::vector< ::msgs::MsgRadarObject_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::msgs::MsgRadarObject_<ContainerAllocator> >::other >  _ObjectList_left_type;
  _ObjectList_left_type ObjectList_left;

   typedef std::vector< ::msgs::MsgRadarObject_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::msgs::MsgRadarObject_<ContainerAllocator> >::other >  _ObjectList_right_type;
...
struct Printer< ::msgs::MsgRadar_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::msgs::MsgRadar_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.ObjectList_left.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::msgs::MsgRadarObject_<ContainerAllocator> >::stream(s, indent + "    ", v.ObjectList_left[i]);
    }
    ...
    for (size_t i = 0; i < v.ObjectList_right.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::msgs::MsgRadarObject_<ContainerAllocator> >::stream(s, indent + "    ", v.ObjectList_right[i]);
    }
  }
};
