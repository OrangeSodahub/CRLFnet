...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_gazebo_plugins_SOURCE_PREFIX /home/zonlin/CRLFnet/src/velodyne/velodyne_gazebo_plugins)
  set(velodyne_gazebo_plugins_DEVEL_PREFIX /home/zonlin/CRLFnet/devel)
  ...
  set(velodyne_gazebo_plugins_INSTALL_PREFIX /home/zonlin/CRLFnet/install)
...
if(NOT "/home/zonlin/CRLFnet/src/velodyne/velodyne_gazebo_plugins/include;/usr/include;/usr/include/gazebo-11;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-9.7;/usr/include/ignition/math6;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport8;/usr/include/ignition/msgs5;/usr/include/ignition/common3;/usr/include/ignition/fuel_tools4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zonlin/CRLFnet/src/velodyne/velodyne_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zonlin/CRLFnet/devel/lib;/home/zonlin/CRLFnet/devel/lib;/opt/ros/noetic/lib)
