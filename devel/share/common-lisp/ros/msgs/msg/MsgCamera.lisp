...
(cl:defmethod cl:initialize-instance :after ((m <MsgCamera>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgCamera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs-msg:<MsgCamera> is deprecated: use msgs-msg:MsgCamera instead.")))
...
(cl:defmethod camera-val ((m <MsgCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs-msg:camera-val is deprecated.  Use msgs-msg:camera instead.")
  (camera m))
