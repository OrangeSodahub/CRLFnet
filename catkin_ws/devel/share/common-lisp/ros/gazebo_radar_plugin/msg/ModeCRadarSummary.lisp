...
(cl:defclass <ModeCRadarSummary> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (contacts
    :reader contacts
    :initarg :contacts
    :type (cl:vector gazebo_radar_plugin-msg:ModeCRadar)
   :initform (cl:make-array 0 :element-type 'gazebo_radar_plugin-msg:ModeCRadar :initial-element (cl:make-instance 'gazebo_radar_plugin-msg:ModeCRadar))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ModeCRadarSummary>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ModeCRadarSummary)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_radar_plugin-msg:<ModeCRadarSummary> is deprecated: use gazebo_radar_plugin-msg:ModeCRadarSummary instead.")))
...
(cl:defmethod contacts-val ((m <ModeCRadarSummary>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_radar_plugin-msg:contacts-val is deprecated.  Use gazebo_radar_plugin-msg:contacts instead.")
  (contacts m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ModeCRadarSummary>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'contacts)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'gazebo_radar_plugin-msg:ModeCRadar))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ModeCRadarSummary>)))
  ...
  "gazebo_radar_plugin/ModeCRadarSummary")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ModeCRadarSummary)))
  "Returns string type for a message object of type 'ModeCRadarSummary"
  "gazebo_radar_plugin/ModeCRadarSummary")
