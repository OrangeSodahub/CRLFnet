...
(cl:defmethod cl:initialize-instance :after ((m <ModeCRadar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ModeCRadar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name site-msg:<ModeCRadar> is deprecated: use site-msg:ModeCRadar instead.")))
...
(cl:defmethod range-val ((m <ModeCRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader site-msg:range-val is deprecated.  Use site-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'bearing-val :lambda-list '(m))
(cl:defmethod bearing-val ((m <ModeCRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader site-msg:bearing-val is deprecated.  Use site-msg:bearing instead.")
  (bearing m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <ModeCRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader site-msg:altitude-val is deprecated.  Use site-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <ModeCRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader site-msg:code-val is deprecated.  Use site-msg:code instead.")
  (code m))

(cl:ensure-generic-function 'ident-val :lambda-list '(m))
(cl:defmethod ident-val ((m <ModeCRadar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader site-msg:ident-val is deprecated.  Use site-msg:ident instead.")
  (ident m))
