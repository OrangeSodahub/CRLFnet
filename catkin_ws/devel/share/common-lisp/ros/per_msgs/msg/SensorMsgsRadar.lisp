...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SensorMsgsRadar>)))
  ...
  "5b695fa4723d4915d6ab0e488542236e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SensorMsgsRadar)))
  "Returns md5sum for a message object of type 'SensorMsgsRadar"
  "5b695fa4723d4915d6ab0e488542236e")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SensorMsgsRadar>))
  (cl:+ 0
     ...
     4
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'front_esr_tracklist) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'front_right_esr_tracklist) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'front_left_esr_tracklist) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
