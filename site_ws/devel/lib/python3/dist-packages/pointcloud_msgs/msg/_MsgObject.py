...
"""autogenerated by genpy from pointcloud_msgs/MsgObject.msg. Do not edit."""
import codecs
import sys
...
uint32 count     # How many elements in the field"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint32','pointcloud_msgs/PointField[]','bool','uint32','uint32','uint8[]','bool']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pointcloud_msgs.msg.PointField()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
