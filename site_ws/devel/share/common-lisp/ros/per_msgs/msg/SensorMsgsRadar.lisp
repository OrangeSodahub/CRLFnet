...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SensorMsgsRadar>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'fsm4_tracker_counter))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'fsm4_tracklist))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'fsm4_tracklist))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'rear_sbmp_tracklist))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'rear_sbmp_tracklist))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SensorMsgsRadar>) istream)
  ...
  (cl:setf (cl:slot-value msg 'fsm4_tracklist) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'fsm4_tracklist)))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'rear_sbmp_tracklist) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'rear_sbmp_tracklist)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'per_msgs-msg:GeometryMsgsRadarObject))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SensorMsgsRadar>)))
  ...
  "204a30d198cfa61f97a58275109baa3e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SensorMsgsRadar)))
  "Returns md5sum for a message object of type 'SensorMsgsRadar"
  "204a30d198cfa61f97a58275109baa3e")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SensorMsgsRadar>))
  (cl:+ 0
     ...
     4
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'fsm4_tracklist) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'rear_sbmp_tracklist) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
