...
int main(int argc, char **argv)
{
    ...
    pcl::io::loadPCDFile ("/home/zonlin/ROS/site_ws/src/site_model/point_cloud_data/point_cloud_filtered_downsampled.pcd", cloud);
    ...
    //保存点云文件
    if(pcl::io::savePCDFileASCII ("/home/zonlin/ROS/site_ws/src/site_model/point_cloud_data/point_cloud_segmented_on_RANSAC.pcd", cloud_segmented)>=0)
