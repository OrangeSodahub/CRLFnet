...
int main(int argc, char** argv)
{
    ...
    if (pcl::io::loadPCDFile <pcl::PointXYZ>("/home/zonlin/ROS/site_ws/src/site_model/point_cloud_data/point_cloud_segmented_on_RANSAC.pcd", *cloud) >= 0)
    ...
    {
        pcl::io::savePCDFile("/home/zonlin/ROS/site_ws/src/site_model/point_cloud_data/point_cloud_segmented_on_region_growing.pcd", *colored_cloud);
